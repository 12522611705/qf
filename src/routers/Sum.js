...
class component extends Component{
                            ...
                            Modal.confirm({
                                ...
                                content:<div>
                                    <Table rowKey={record=>record.id} 
                                        ...
                                        dataSource={record.lists.slice(1)} />
                                </div>,
                                okText:'确定',
                                cancelText:'取消'
                            })
    ...
    initIndex(updateParams){
        ...
        Ajax.get({
            url:config.Sum.urls.garbageSumQuantity,
            params:{
                ...params,
            ...
            success:(data)=>{
                ...
                _this.drawBar(data.lists.slice(1),'bar');
            }
        })
    }
    // 画柱状图
        ...
        return (
            <div className="content">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item><a href="javascript:;">垃圾分类数据汇总</a></Breadcrumb.Item>
                </Breadcrumb>

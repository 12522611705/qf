...
class component extends Component{
        ...
        this.state = {
            ...
            indexTable:{
                ...
                head:[
                    ...
                    { title: '非活跃用户', dataIndex: 'noActiveUser', key: 'noActiveUser' },
    ...
    initIndex(updateParams){
        ...
        Ajax.get({
            url:config.Active.urls.userActiveQuantity,
            params:{
                ...params,
        ...
        return (
            <div className="content">
                <Breadcrumb>
                    ...
                    <Breadcrumb.Item><a href="javascript:;">活跃和非活跃用户数量的统计</a></Breadcrumb.Item>
                </Breadcrumb>
                ...
                <Table 
                    rowKey={record=>record.activeUser} 
                    rowSelection={{
